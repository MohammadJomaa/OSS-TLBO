...
public class TLBOPSO {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            TLBOPSO T = new TLBOPSO(10, 1000, 100, -100, 100, 0);
    ...
    public TLBOPSO(int PopulationCount, int MaxIteration, int NumberOf_Dimensions, double RangeMin, double RangeMax, double F_Min) {
