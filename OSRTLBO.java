...
public class OSRTLBO {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            OSRTLBO T = new OSRTLBO(10, 1000, 100, -100, 100, 0);
    ...
    public OSRTLBO(int PopulationCount, int MaxIteration, int NumberOf_Dimensions, double RangeMin, double RangeMax, double F_Min) {
